    ...
    <div class="container">
        <?php while ( have_posts() ) : the_post(); ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <header class="entry-header" style="text-align:center; margin-bottom:80px; max-width:900px; margin-left:auto; margin-right:auto;">
                    <div style="font-size:12px; font-weight:900; color:var(--accent); text-transform:uppercase; letter-spacing:4px; margin-bottom:20px;">SUCCESS TRANSFORMATION</div>
                    <h1 class="text-gradient" style="font-size:4rem; margin-bottom:30px;"><?php the_title(); ?></h1>
                    <?php if ( has_excerpt() ) : ?>
                        <p style="font-size:1.5rem; opacity:0.8; line-height:1.5;"><?php echo get_the_excerpt(); ?></p>
                    <?php endif; ?>
                </header>
                ...
                <div class="wp-block-columns" style="gap:60px;">
                    <div class="wp-block-column" style="flex-basis:65%;">
                        <div class="glass-card" style="padding:50px;">
                            ...
                            <div class="entry-content" style="font-size:1.15rem; line-height:1.8;">
                                <?php the_content(); ?>
                            </div>
                        </div>
                    </div>
