        ...
        <div style="max-width:800px; margin:0 auto;" class="gp-reveal">
            <?php if ( ! is_user_logged_in() ) : ?>
                <div class="glass-card" style="padding:100px 80px; text-align:center;">
                    ...
                    <h1 class="text-gradient" style="font-size:3.5rem; margin-bottom:20px;">Portal Command</h1>
                    <p style="font-size:1.2rem; opacity:0.6; margin-bottom:50px;">Identify yourself to access proprietary growth metrics, financial ledgers, and strategic documents.</p>
