...
<main id="primary" class="site-main grainy-bg" style="padding-top:100px; padding-bottom:120px;">
    <div class="container">
        <div style="margin-bottom:40px;">
            <a href="/knowledge-base" style="font-size:11px; font-weight:950; letter-spacing:2px; text-decoration:none; opacity:0.4;">&larr; BACK TO HUB</a>
        </div>

        <?php while ( have_posts() ) : the_post(); ?>
            <div class="wp-block-columns" style="gap:60px;">
                <div class="wp-block-column" style="flex-basis:70%;">
                    <article id="post-<?php the_ID(); ?>" <?php post_class('glass-card'); ?> style="padding:70px; border-radius:44px;">
                        <header class="entry-header">
                            <div style="font-size:10px; font-weight:900; color:var(--primary); text-transform:uppercase; letter-spacing:3px; margin-bottom:15px;">TECHNICAL INTELLIGENCE</div>
                            <h1 class="text-gradient" style="margin-bottom:40px; font-size:3.5rem; line-height:1.1; letter-spacing:-0.05em;"><?php the_title(); ?></h1>
                        </header>

                        <div class="entry-content" style="font-size:1.2rem; line-height:1.8; color:var(--text); opacity:0.8;">
                            <?php the_content(); ?>
                        </div>
