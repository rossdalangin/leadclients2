...
<main id="primary" class="site-main grainy-bg" style="padding-top:100px; padding-bottom:120px;">
    <div class="container">
        <div style="text-align:center; margin-bottom:80px;" class="gp-reveal">
            <div style="font-size:12px; font-weight:950; color:var(--primary); text-transform:uppercase; letter-spacing:4px; margin-bottom:25px;">CAPITAL ALLOCATION</div>
        ...
        <div class="wp-block-columns" style="gap:40px; margin-top:80px;" class="gp-reveal">
        ...
        <div style="margin-top:120px;" class="gp-reveal">
            <?php echo do_shortcode('[gp_trust_badges]'); ?>
        </div>
    </div>
</main>
